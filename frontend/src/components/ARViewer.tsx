...
interface Props {
  item: MenuItem;
  /** Called when user taps the AR launch button. */
  onActivate?: () => void;
}

// model-viewer activates AR via .activateAR() on the element.
// We expose a custom CTA so the design stays editorial and
// matches the "View on your table" pattern from the reference.
